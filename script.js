...
// Dev Shop code - write your function from the TODO here
  ...
  function updateCupcakeOfTheDay() {
    let flavorOfTheDay = findFlavorObject()

    let cupcakeNameElement = document.getElementById("featured-cupcake-name");
    // let cupcakeNameElement = document.querySelector("#featured-cupcake-name");
    cupcakeNameElement.innerText = flavorOfTheDay.name

    let cupcakeImgElement = document.getElementById("featured-cupcake-img");
    cupcakeImgElement.src = flavorOfTheDay.img
  }
